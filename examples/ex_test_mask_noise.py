...
if __name__ == "__main__":
    ...
    argparser.add_argument("--noise", type=str, default="MaskGaussianNoise")
    ...
    x = (get_dataset("cifar", "train").data / 256)[:args.batch_size]
    ...
    x = x.unsqueeze(1).repeat((1,2,1,1,1))
    rvs = noise.sample(x) - x
